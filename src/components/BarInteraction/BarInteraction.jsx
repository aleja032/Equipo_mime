...
function BarInteraction({ postId }) {
    ...
    // Generar números aleatorios para "Like" y "Share"
    const randomLikes = Math.floor(Math.random() * 100); // Cambia 100 por el máximo que desees
    const randomShares = Math.floor(Math.random() * 100); // Cambia 100 por el máximo que desees
